...
import 'package:capcafe_app/Models/placePredictions.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String placeAddress = Provider.of<appDate>(context).pickUpLocation.placeName ?? "";
  ...
  void findPlace(String placeName) async
  {
    ...
    {
      String autoCompleteUrl ="https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=contry:eg";
...
class PredictionTile extends StatelessWidget
{
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    showDialog(
        context: context,
        builder: (BuildContext context) => progressDilog (massage: "Setting Dropoff, Please wait...",)
    );
    ...
    if(res["status"] == "OK") {
      ...
      Provider.of<appDate>(context, listen: false).updateDropOffLocationAddress(address);
